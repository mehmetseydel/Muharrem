...
(function ($) {
  ...
  setTimeout(function () {
    if (window.___browserSync___ === undefined && Number(localStorage.getItem('AdminLTE:Demo:MessageShowed')) < Date.now()) {
      ...
      alert('MuharremGirişim\'in "demo.js" dosyasını yüklüyorsunuz, \nbu dosya sadece test amaçlı oluşturulmuştur!')
    }
  }, 1000)
  ...
  $container.append(
    '<h5>Muharrem Girişim</h5><hr class="mb-2"/>'
  )
  ...
  var $dark_mode_container = $('<div />', { class: 'mb-4' }).append($dark_mode_checkbox).append('<span>Koyu Mod</span>')
